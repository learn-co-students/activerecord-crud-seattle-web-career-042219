...
def can_be_instantiated_and_then_saved
  movie = Movie.create(title: "The Dark Knight", release_date: 07072007, director: "Christopher Nolan", lead: "Chirstian Bale", in_theaters: false)
  movie.title = "This is a title."
  movie.update_column(:title, "This is a title.")
  #binding.pry
end
...
def can_be_found_updated_and_saved
  ...
  Movie.all.find_by(title: "Awesome Flick").update_columns(title: "Even Awesomer Flick")
end
...
def can_update_using_update_method
  ...
  #binding.pry
  Movie.all.find_by(title: "Wat?").update(title: "Wat, huh?")
end
